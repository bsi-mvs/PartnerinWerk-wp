...
class DMPRO_ContentToggle extends ET_Builder_Module {
	...
	public function init() {
		$this->name      = esc_html__( DMPRO_PREFIX . 'Content Toggle', 'dmpro-divi-modules-pro' );
		...
		$this->settings_modal_toggles = [
			'general'  => [
				'toggles' => [
				    'toggle_content' => [
                        ...
                        'title' => esc_html__( 'Toggle Content', 'dmpro-divi-modules-pro'),
                        'priority' => 1,
		            ],
			    ],
			],
			'advanced' => [
				'toggles' => [
					'switcher'    => esc_html__( 'Toggle Switch', 'dmpro-divi-modules-pro' ),
					'heading_one' => esc_html__( 'First Title', 'dmpro-divi-modules-pro' ),
					'heading_two' => esc_html__( 'Second Title', 'dmpro-divi-modules-pro' ),
					'content_one' => esc_html__( 'First Content', 'dmpro-divi-modules-pro' ),
					'content_two' => esc_html__( 'Second Content', 'dmpro-divi-modules-pro' ),
				],
			],
		];
	}
	...
	public function get_fields() {
		...
		$module_fields['heading_one'] = [
				'label'           => esc_html__( 'First Title', 'dmpro-divi-modules-pro' ),
				'type'            => 'text',
				'default'         => 'Option One',
		...
		$module_fields['content_type_one'] = [
				'label'            => esc_html__( 'Content Type', 'dmpro-divi-modules-pro' ),
				'type'             => 'select',
				'default'          => 'content',
				'options'          => array(
		...
		$module_fields['library_id_one'] = [
				'label'            => __( 'Select Library Layout', 'dmpro-divi-modules-pro' ),
				'type'             => 'select',
		...
		$module_fields['custom_content_one'] = [
				'label'           => esc_html__( 'Content', 'dmpro-divi-modules-pro' ),
				'type'            => 'tiny_mce',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Write your content or paste a shortcode.', 'dmpro-divi-modules-pro' ),
				'toggle_slug'     => 'toggle_content',
				'sub_toggle' => 'first_content',
				'dynamic_content' => 'text',
				'show_if'         => array(
		...
		$module_fields['heading_two'] = [
				'label'           => esc_html__( 'Second Title', 'dmpro-divi-modules-pro' ),
				'type'            => 'text',
				'default'         => 'Option Two',
				'toggle_slug'     => 'toggle_content',
		...
		$module_fields['alignment'] = [
				'label'          => esc_html__( 'Toggle Switch Alignment', 'dmpro-divi-modules-pro' ),
				'type'           => 'select',
				'default'        => 'center',
				'mobile_options' => true,
				'options'        => array(
		...
		$module_fields['content_padding_one'] = [
				'label'          => __( 'Content Padding', 'dmpro-divi-modules-pro' ),
				'type'           => 'custom_padding',
		...
		$module_fields['content_spacing_top_one'] = [
				'label'          => esc_html__( 'Content Spacing Top', 'dmpro-divi-modules-pro' ),
				'type'           => 'range',
				'default'        => '25px',
				'default_unit'   => 'px',
				'range_settings' => array(
		...
		$module_fields['content_fullwidth_one'] = [
				'label'            => esc_html__( 'Make This Layout Fullwidth', 'dmpro-divi-modules-pro' ),
				'type'             => 'yes_no_button',
				...
				'description'      => esc_html__( 'Here you can choose to make your row and section in the layout fullwidth.', 'dmpro-divi-modules-pro' ),
			];
	...
	public function get_advanced_fields_config() {
		...
		$advanced_fields['fonts']['heading_one'] = array(
			'label'           => esc_html__( 'Heading', 'dmpro-divi-modules-pro' ),
			'css'             => array(
	...
	protected function get_divi_library_options() {
		...
		$layouts[0] = esc_html__( '-- Select Layout --', 'dmpro-divi-modules-pro' );
	...
	public function render( $attrs, $content = null, $render_slug ) {
	    ...
	    wp_enqueue_script("dmpro-".$this->slug, plugin_dir_url(__FILE__) . 'custom.js', array('jquery'), DMPRO_VERSION, true);
