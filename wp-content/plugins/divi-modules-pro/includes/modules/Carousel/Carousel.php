...
class DMPRO_Carousel extends ET_Builder_Module {
   ...
   protected $module_credits = array(
    ...
    public function init() {
        ...
        $this->vb_support = 'on';
        $this->name = esc_html__(DMPRO_PREFIX . 'Carousel', 'dmpro-divi-modules-pro');
        $this->child_slug = 'dmpro_carousel_child';
        $this->main_css_element = '%%order_class%%.dmpro_carousel';
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'carousel' => esc_html__('Carousel Settings', 'dmpro-divi-modules-pro'),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'overlay' => esc_html__('Overlay', 'dmpro-divi-modules-pro'),
                    'alignment' => esc_html__('Alignment', 'dmpro-divi-modules-pro'),
                    'carousel_text' => [
                        'sub_toggles' => [
                            'title' => array(
                                'name' => 'Title',
                        ...
                        'title' => esc_html__( 'Carousel Text', 'dmpro-divi-modules-pro'),
                    ],
                    'carousel_item' => esc_html__('Carousel Item', 'dmpro-divi-modules-pro'),
                    'navigation' => esc_html__('Carousel Navigation', 'dmpro-divi-modules-pro'),
                    'pagination' => esc_html__('Carousel Pagination', 'dmpro-divi-modules-pro'),
                ],
            ],
        ];
    }
    ...
    public function get_fields() {
        ...
        $module_fields['columns'] = [
            'label' => esc_html('Number of Columns', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '4',
            'range_settings' => [
                'min'  => '1',
        ...
        $module_fields['space_between'] = [
            'label' => esc_html('Spacing', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '30',
            'range_settings' => [
                'min'  => '5',
        ...
        $module_fields['container_padding'] = [
            'label' => esc_html('Container Padding', 'dmpro-divi-modules-pro'),
            'type' => 'custom_margin',
        ...
        $module_fields['effect'] = [
            'label' => esc_html__( 'Transition Effect', 'dmpro-divi-modules-pro' ),
            'type' => 'select',
            'option_category' => 'layout',
            'options' => [
                'coverflow' => esc_html__( 'Coverflow', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['slide_shadows'] = [
            'label' => esc_html__( 'Slide Shadow', 'dmpro-divi-modules-pro' ),
            'type' => 'yes_no_button',
        ...
        $module_fields["shadow_overlay_color"] = [
            'label' => esc_html__( 'Side Item Color', 'dmpro-divi-modules-pro' ),
            'type' => 'color-alpha',
            'show_if' => [
                'effect' => 'coverflow',
            ],
        ...
        $module_fields['rotate'] = [
            'label' => esc_html( 'Rotate', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'range_settings ' => [
                'min' => '0',
                'max' => '100',
        ...
        $module_fields['speed'] = [
            'label' => esc_html__( 'Transition Duration', 'dmpro-divi-modules-pro' ),
            'type' => 'range',
            'range_settings' => [
                'min'  => '1',
                'max'  => '5000',
        ...
        $module_fields['loop'] = [
            'label' => esc_html__( 'Enable Carousel Loop', 'dmpro-divi-modules-pro' ),
            'type' => 'yes_no_button',
            'option_category'  => 'configuration',
            'options' => [
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['autoplay'] = [
            'label' => esc_html__( 'Enable Carousel Autoplay', 'dmpro-divi-modules-pro' ),
            'type' =>  'yes_no_button',
            'options' => [
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['pause_on_hover'] = [
            'label' =>  esc_html__('Pause on Hover', 'dmpro-divi-modules-pro'),
            'type' =>  'yes_no_button',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
                'on'  => esc_html__('Yes', 'dmpro-divi-modules-pro')
        ...
        $module_fields['autoplay_speed'] = [
            'label' => esc_html__( 'Autoplay Speed', 'dmpro-divi-modules-pro' ),
            'type' => 'range',
        ...
        $module_fields['navigation'] = [
            'label' =>  esc_html__( 'Enable Carousel Navigation', 'dmpro-divi-modules-pro'),
            'type' =>  'yes_no_button',
            'options' => [
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['pagination'] = [
            'label' =>  esc_html__( 'Enable Carousel Pagination', 'dmpro-divi-modules-pro'),
            'type' =>  'yes_no_button',
            'options' => [
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' )
        ...
        $module_fields['dynamic_bullets'] = [
            'label' =>  esc_html__( 'Dynamic Bullets', 'dmpro-divi-modules-pro'),
            'type' =>  'yes_no_button',
            'options' => [
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on' => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['centered'] = [
            'label' => esc_html__( 'Enable Centered Carousel', 'dmpro-divi-modules-pro' ),
            'type' => 'yes_no_button',
            'option_category'  => 'configuration',
            'options' => array(
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['navigation_prev_icon_yn'] = [
            'label' =>  esc_html__('Prev Nav Custom Icon', 'dmpro-divi-modules-pro'),
            'type' =>  'yes_no_button',
            'options' => [
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['navigation_prev_icon'] = [
            'label' => esc_html__( 'Select Previous Nav icon', 'dmpro-divi-modules-pro' ),
            'type'  => 'select_icon',
        ...
        $module_fields['navigation_next_icon_yn'] = [
            'label' =>  esc_html__('Next Nav Custom Icon', 'dmpro-divi-modules-pro'),
            'type' =>  'yes_no_button',
            'options' => array(
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['navigation_next_icon'] = [
            'label' => esc_html__( 'Select Next Nav icon', 'dmpro-divi-modules-pro' ),
            'type' => 'select_icon',
            'class' => array('et-pb-font-icon'),
            'default' => '9',
        ...
        $module_fields['navigation_size'] = [
            'label' => esc_html__('Icon Size', 'dmpro-divi-modules-pro' ),
            'type' => 'range',
            'range_settings'  => array(
                'min'  => '1',
                'max'  => '100',
        ...
        $module_fields['navigation_padding'] = [
            'label' => esc_html__( 'Icon Padding', 'dmpro-divi-modules-pro' ),
            'type' => 'range',
            'range_settings'  => [
                'min'  => '1',
                'max'  => '100',
        ...
        $module_fields['navigation_color'] = [
            'label' => esc_html( 'Arrow Color', 'dmpro-divi-modules-pro' ),
            'type'  =>  'color-alpha',
        ...
        $module_fields['navigation_bg_color'] = [
            'label' => esc_html( 'Arrow Background', 'dmpro-divi-modules-pro' ),
            'type' => 'color-alpha',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'navigation'
        ];
        ...
        $module_fields['navigation_circle'] = [
            'label' => esc_html__( 'Circle Arrow', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'options' => array(
                'off' => esc_html__( 'No', 'dmpro-divi-modules-pro' ),
                'on'  => esc_html__( 'Yes', 'dmpro-divi-modules-pro' ),
        ...
        $module_fields['navigation_position_left'] = [
            'label' => esc_html('Left Navigation Postion', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '-66px',
        ...
        $module_fields['navigation_position_right'] = [
            'label' => esc_html('Right Navigation Postion', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '-66px',
            'default_on_front'=> '-66px',
            'default_unit' => 'px',
        ...
        $module_fields['pagination_position'] = [
            'label' => esc_html('Pagination Postion', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '-40',
            'range_settings' => [
                'min'  => '-200',
        ...
        $module_fields['pagination_color'] = [
            'label' => esc_html( 'Pagination Color', 'dmpro-divi-modules-pro' ),
            'type'  =>  'color-alpha',
            'default' => '#d8d8d8',
            'show_if' => ['pagination' => 'on'],
            'tab_slug' => 'advanced',
        ...
        $module_fields['pagination_active_color'] = [
            'label' => esc_html( 'Pagination Active Color', 'dmpro-divi-modules-pro' ),
            'type'  =>  'color-alpha',
            'default'   => et_builder_accent_color(),
            'show_if'   => ['pagination' => 'on'],
            'tab_slug'  => 'advanced',
    ...
    public function get_custom_css_fields_config() {
        ...
        $custom_css_fields['navigation'] = [
            'label'    => esc_html__('Carousel Navigation', 'dmpro-divi-modules-pro'),
            'selector' => '%%order_class%% .swiper-arrow-button',
        ];

        $custom_css_fields['pagination'] = [
            'label'    => esc_html__('Carousel Pagination', 'dmpro-divi-modules-pro'),
    ...
    public function render($attrs, $content = null, $render_slug) {
        wp_enqueue_style("dmpro-".$this->slug, plugin_dir_url(__FILE__) . 'style.css', ['dmpro_swiper_style'], DMPRO_VERSION , 'all');
        wp_enqueue_script("dmpro-".$this->slug, plugin_dir_url(__FILE__) . 'custom.js', array('jquery', 'dmpro_swiper_script'), DMPRO_VERSION, false, true);
