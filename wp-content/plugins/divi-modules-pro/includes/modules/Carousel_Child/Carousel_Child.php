...
class DMPRO_Carousel_Child extends ET_Builder_Module {
    ...
    public function init() {
        ...
        $this->name = esc_html__( 'Carousel Slide', 'dmpro-divi-modules-pro' );
        $this->plural = esc_html__( 'Carousel Slides', 'dmpro-divi-modules-pro' );
        $this->slug = 'dmpro_carousel_child';
        $this->vb_support = 'on';
        $this->type = 'child';
        $this->child_title_var = 'title';
        $this->advanced_setting_title_text = esc_html__( 'New Slide', 'dmpro-divi-modules-pro' );
        $this->settings_text = esc_html__( 'Slide Settings', 'dmpro-divi-modules-pro' );
        $this->main_css_element = '%%order_class%%';

        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'main_content' => esc_html__('Content', 'dmpro-divi-modules-pro'),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'icon_settings' => esc_html__( 'Icon', 'dmpro-divi-modules-pro' ),
                    'img_settings' => esc_html__('Image', 'dmpro-divi-modules-pro' ),
                    'carousel_text' => [
                        'sub_toggles' => [
                            'title' => [ 'name' => 'Title' ],
                            'desc' => [ 'name' => 'Desc' ],
    ...
    public function get_fields() {
        ...
        $module_fields["type"] = [
            ...
            'default' => 'default',
            'options' => [
                'default' => esc_html__('Default', 'dmpro-divi-modules-pro'),
                'divi_library' => esc_html__('Divi Library', 'dmpro-divi-modules-pro'),
            ],
            'toggle_slug' => 'main_content',
            'affects' => [
                'use_icon',
        ...
        $module_fields["use_icon"] = [
            'label' => esc_html__( 'Enable Carousel Icon', 'dmpro-divi-modules-pro' ),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
        ...
        $module_fields["carousel_icon_align"] = [
            'label' => esc_html__('Carousel Icon Alignment', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'default' => 'center',
            'options' => [
        ...
        $module_fields['img_width'] = [
            'label' => esc_html('Image Width', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '100',
            'default_unit' => '%',
            'default_on_front'=> '',
