...
class DMPRO_MasonryGallery extends ET_Builder_Module
{
    ...
    public function init()
    {
        ...
        $this->vb_support = 'on';
        $this->name = esc_html__(DMPRO_PREFIX . 'Masonry Gallery', 'dmpro-divi-modules-pro');
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'images' => esc_html__('Images', 'dmpro-divi-modules-pro'),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'grid' => esc_html__('Grid Options', 'dmpro-divi-modules-pro'),
                    'grid_items' => esc_html__('Grid Items', 'dmpro-divi-modules-pro'),
                    'overlay' => esc_html__('Image Overlay', 'dmpro-divi-modules-pro'),
                ],
            ],
        ];
    }
    ...
    public function get_fields() {
        ...
        $fields["images"] = [
            'label' => esc_html__('Gallery Images', 'dmpro-divi-modules-pro'),
            'type' => 'upload-gallery',
        ...
        $fields['gallery_orderby'] = array(
            'label'   => esc_html__( 'Order By', 'dmpro-divi-modules-pro'),
            'type'    => $this->is_loading_bb_data() ? 'hidden' : 'select',
            'options' => array(
                ''     => esc_html__( 'Default', 'dmpro-divi-modules-pro'),
                'rand' => esc_html__( 'Random', 'dmpro-divi-modules-pro'),
            ),
            'default' => 'off',
        ...
        $fields["title_in_lightbox"] = [
            'label' => esc_html__('Show Image Title in Lightbox', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'default' => 'off',
            'options' => array(
            ...
            'toggle_slug' => 'images',
            'description' => esc_html__('Whether or not to show the image title in the lightbox. The title is automatically loaded from the media library.', 'dmpro-divi-modules-pro'),
            'computed_affects'   => array(
                '__gallery',
            ),
        ];
        ...
        $fields["caption_in_lightbox"] = [
            'label' => esc_html__('Show Image Caption in Lightbox', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'default' => 'off',
            'options' => array(
            ...
            'toggle_slug' => 'images',
            'description' => esc_html__('Whether or not to show the image caption in the lightbox. The caption is automatically loaded from the media library.', 'dmpro-divi-modules-pro'),
            'computed_affects'   => array(
                '__gallery',
            ),
        ];
        ...
        $fields["columns"] = [
            'label' => esc_html__('Columns', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'option_category' => 'basic_option',
            'toggle_slug' => 'grid',
            'tab_slug' => 'advanced',
        ...
        $fields["gutter"] = [
            'label' => esc_html__('Gutter', 'dmpro-divi-modules-pro'),
            'type' => 'range',
        ...
        $fields["show_overflow"] = [
            'label' => esc_html__('Show Overflow', 'dmpro-divi-modules-pro'),
            'description' => esc_html__('Enable to show the overflow of the module. This is needed for box shadows to show properly, however keep it off to show rounded corners.', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'layout',
            'toggle_slug' => 'grid',
            'tab_slug' => 'advanced',
        ...
        $fields["use_overlay"] = [
            'label' => esc_html__('Use Overlay', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'overlay',
        ...
        $fields['overlay_icon_color'] = array(
            'label' => esc_html__(' Overlay Icon Color', 'dmpro-divi-modules-pro'),
            'type' => 'color-alpha',
            'custom_color' => true,
            'tab_slug' => 'advanced',
            'default' => '',
            ...
            'toggle_slug' => 'overlay',
            'description' => esc_html__('Color of the overlay icon. The overlay icon is centered horizontally and vertically over the image.', 'dmpro-divi-modules-pro'),
        );

        $fields['hover_icon'] = array(
            'label' => esc_html__('Overlay Icon', 'dmpro-divi-modules-pro'),
            'type'                => 'select_icon',
        ...
        $fields['use_thumbnails'] = [
            'label' => esc_html__('Use Responsive Thumbnails', 'dmpro-divi-modules-pro'),
            'description' => esc_html__('Whether or not to use custom sized thumbnails on different devices. If this option is disabled, the full size image will be used as thumbnail.', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'toggle_slug' => 'images',
            'default' => 'off',
        ...
        $fields['image_size_desktop'] = [
            'label' => esc_html__('Image Size (Desktop)', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'full',
        ...
        $fields['image_size_tablet'] = [
            'label' => esc_html__('Image Size (Tablet)', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'full',
            'options' => $this->get_image_sizes(),
        ...
        $fields['image_size_phone'] = [
            'label' => esc_html__('Image Size (Phone)', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'full',
            'options' => $this->get_image_sizes(),
    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields["box_shadow"]["images"] = [
            'label' => esc_html__('Grid Item Box Shadow', 'dmpro-divi-modules-pro'),
            'toggle_slug' => 'grid_items',
            'tab_slug' => 'advanced',
            'css' => [
    ...
    public function render($attrs, $content = null, $render_slug) {
        wp_enqueue_style("dmpro".$this->slug, plugin_dir_url(__FILE__) . 'style.css', ['dmpro_animate_style', 'dmpro_magnific_popup_style'], "1.0.0", 'all');
        wp_enqueue_script("dmpro-".$this->slug, plugin_dir_url(__FILE__) . 'custom.js', array('dmpro_masonry_script'), DMPRO_VERSION, false, true);
    ...
    public function get_image_sizes()
    {
        ...
        $image_sizes = array(
            'full' => esc_html__('Full Size', 'dmpro-divi-modules-pro'),
        );
