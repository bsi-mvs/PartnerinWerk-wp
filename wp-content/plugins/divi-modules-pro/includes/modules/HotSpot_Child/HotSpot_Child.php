...
class DMPRO_HotSpot_Child extends ET_Builder_Module
{
    ...
    public function init()
    {
        ...
        $this->vb_support = 'on';
        $this->type = 'child';
        $this->name = esc_html__('Marker', 'dmpro-divi-modules-pro');
        $this->plural = esc_html__('Hotspots', 'dmpro-divi-modules-pro');
        $this->child_title_var = 'title';
        $this->advanced_setting_tooltip_title = esc_html__('New Hotspot', 'dmpro-divi-modules-pro');
        $this->settings_text = esc_html__('Marker', 'dmpro-divi-modules-pro');
        $this->main_css_element = '%%order_class%%'; 
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'hotspot' => esc_html__('Hotspot Marker', 'dmpro-divi-modules-pro'),
                    'tooltip' => esc_html__('Hotspot Tooltip', 'dmpro-divi-modules-pro'),
                    'settings' => esc_html__('Hotspot Settings', 'dmpro-divi-modules-pro'),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'hotspot_icon_image' => esc_html__('Hotspot', 'dmpro-divi-modules-pro'),
                    'hotspot_ripple_effect' => esc_html__('Marker Pulse Effect', 'dmpro-divi-modules-pro'),
                    'tooltip_styles' => esc_html__('Tooltip Image/Icon', 'dmpro-divi-modules-pro'),
                    'tooltip_text' => [
                        'sub_toggles' => [
                            'title' => [
                                'name' => 'Title',
                        ...
                        'title' => esc_html__('Tooltip Text', 'dmpro-divi-modules-pro'),
                        'priority' => 49,
                    ],
                    'tooltip_box' => esc_html__('Tooltip Box', 'dmpro-divi-modules-pro'),
                ],
            ]
        ];
    }
    ...
    public function get_fields(){
        ...
        $fields['use_hotspot_icon'] = [
            'label' => esc_html__('Enable Icon Marker', 'dmpro-divi-modules-pro'),
            'type'  => 'yes_no_button',
            'options' => [
        ...
        $fields["hotspot_image"] = [
            'label' => esc_html__('Image Marker', 'dmpro-divi-modules-pro'),
            'type'               => 'upload',
        ...
        $fields["hotspot_image_width"] = [
            'label' => esc_html__('Hotspot Image Width', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '100px',
            'default_unit' => 'px',
        ...
        $fields["hotspot_ripple_effect"] = [
            'label'   => esc_html__('Enable Marker Pulse Effect', 'dmpro-divi-modules-pro'),
            'type'    => 'yes_no_button',
            'default' => 'off',
            'options' => [
                'on'  => esc_html__('Yes', 'dmpro-divi-modules-pro'),
        ...
        $fields["hotspot_ripple_effect_color"] = [
            'label' => esc_html__('Market Pulse Effect Color', 'dmpro-divi-modules-pro'),
            'type' => 'color-alpha',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'hotspot_ripple_effect'
        ];
        ...
        $fields["hotspot_position_vertical"] = [
            'label' => esc_html__('Marker Vertical Position', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '10%',
            'default_unit' => '%',
            'range_settings' => [
        ...
        $fields["hotspot_position_horizontal"] = [
            'label' => esc_html__('Marker Horizontal Position', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '10%',
            'default_unit' => '%',
            'range_settings' => [
        ...
        $fields["type"] = [
            'label' => esc_html__('Tooltip Type', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'options' => [
                'default' => esc_html__('Default (Text, Icon, Image)', 'dmpro-divi-modules-pro'),
                'library' => esc_html__('Divi Library Layout', 'dmpro-divi-modules-pro'),
            ],
            'default' => 'default',
            'affects' => [
                'use_tooltip_icon',
        ...
        $fields["library_id"] = [
            'label' => esc_html__('Divi Library', 'dmpro-divi-modules-pro'),
        ...
        $fields["use_tooltip_icon"] = [
            'label' => esc_html__('Enable Icon within Tooltip', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'default_on_front' => 'off',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $fields["use_tooltip_icon_circle"] = [
            'label' => esc_html__('Show as Circle Icon', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
                'on'  => esc_html__('Yes', 'dmpro-divi-modules-pro'),
        ...
        $fields['tooltip_image_width'] = [
            'label' => esc_html('Tooltip Image Width', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '100px',
            'default_unit' => 'px',
            'default_on_front' => '100px',
        ...
        $fields["tooltip_bg"] = [
            'label'           => esc_html__('Background Color', 'dmpro-divi-modules-pro'),
            'type'            => 'color-alpha',
            'tab_slug'        => 'advanced',
        ...
        $fields["show_tooltip_button"] = [
            'default' => 'off',
            'label' => esc_html__('Show Button', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'options' => [
                'on' => esc_html__('Yes', 'dmpro-divi-modules-pro'),
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $fields["tooltip_position"] = [
            'label' => esc_html__('Tooltip Position', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'options' => [
                ...
                'bottom' => esc_html__('Bottom', 'dmpro-divi-modules-pro'),
            ],
            'default' => 'left',
        ...
        $fields["tooltip_width"] = [
            'label' => esc_html__('Tooltip Width', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'default' => '300px',
            'default_unit' => 'px',
            'default_on_child' => true,
        ...
        $fields["tooltip_content_align"] = [
            'label'           => esc_html__('Tooltip Content Align', 'dmpro-divi-modules-pro'),
            'type'            => 'select',
            'option_category' => 'basic_option',
            'options' => [
                'left'  => esc_html__('Left', 'dmpro-divi-modules-pro'),
        ...
        $fields['use_tooltip_arrow'] = [
            'label' => esc_html__('Use Tooltip Arrow', 'dmpro-divi-modules-pro'),
            'type'  => 'yes_no_button',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
                'on'  => esc_html__('Yes', 'dmpro-divi-modules-pro')
        ...
        $fields["arrow_color"] = [
            'label'             => esc_html__('Arrow Color', 'dmpro-divi-modules-pro'),
            'type'              => 'color-alpha',
            'default'           => '#000',
            'depends_show_if'   => 'on',
            'toggle_slug'       => 'settings'
        ...
        $fields['tooltip_padding'] = [
            'label' => esc_html('Tooltip Padding', 'dmpro-divi-modules-pro'),
            'type' => 'custom_margin',
    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields['borders']['hotspot_img'] = [
            'label_prefix' => esc_html__('Hotspot Image', 'dmpro-divi-modules-pro'),
            'css' => [
                'main' => [
        ...
        $advanced_fields['borders']['tooltip_img'] = [
            'label_prefix' => esc_html__('Tooltip Image', 'dmpro-divi-modules-pro'),
            'css' => [
                'main' => [
    ...
    private function image_hotspot()
    {
        ...
        $layouts = [
            '0' => __('Select A Layout', 'dmpro-divi-modules-pro')
        ];
