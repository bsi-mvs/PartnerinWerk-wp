...
class DMPRO_FlipBox extends ET_Builder_Module {
    ...
    public function init() {
        ...
        $this->vb_support = 'on';
        $this->name = esc_html__(DMPRO_PREFIX . 'FlipBox', 'dmpro-divi-modules-pro');
            ...
            'general' => [
                'toggles' => [
                     'flipbox_content' => [
                        ...
                        'title' => esc_html__('Flipbox Content', 'dmpro-divi-modules-pro'),
                        'priority' => 1,
                    ],
                    'flipbox_icon_image' => [
                        'sub_toggles' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Flipbox Icon & image', 'dmpro-divi-modules-pro'),
                        'priority' => 1,
                    ],
                    'flipbox_button' => [
                        'sub_toggles' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Flipbox Button', 'dmpro-divi-modules-pro'),
                        'priority' => 1,
                    ],
                    'flipbox_settings' => esc_html__('Flipbox Settings and Animation', 'dmpro-divi-modules-pro'),
                ],
            ],
            ...
            'advanced' => [
                'toggles' => [
                    'flipbox_background' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Flipbox Background', 'dmpro-divi-modules-pro'),
                        'priority' => 49,
                    ],
                    'flipbox_icon_image' => [
                        'sub_toggles' => [
                    ...
                    'front_text' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Front Text', 'dmpro-divi-modules-pro'),
                        'priority' => 49,
                    ],
                    'back_text' => [
                        'sub_toggles' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Back Text', 'dmpro-divi-modules-pro'),
                        'priority' => 49,
                    ],
                    'width' => [
    ...
    public function get_fields() {
        ...
        $module_fields['front_title'] = [
            'label' => esc_html__('Front Side Title', 'dmpro-divi-modules-pro'),
            'type' => 'text',
        ...
        $module_fields['use_front_icon'] = [
            'label' => esc_html__('Enable Front Side Icon', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
        ...
        $module_fields["front_image"] = [
            'label' => esc_html__('Front Image', 'dmpro-divi-modules-pro'),
            'type' => 'upload',
            'option_category' => 'basic_option',
        ...
        $module_fields["front_image_width"] = [
            'label' => esc_html__('Front Image Container Width', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '100%',
            'default_unit' => '%',
        ...
        $module_fields['front_icon'] = [
            'label' => esc_html__('Front Icon', 'dmpro-divi-modules-pro'),
            'type' => 'select_icon',
            'default' => '5',
        ...
        $module_fields['front_content'] = [
            'label' => esc_html__('Front Side Content', 'dmpro-divi-modules-pro'),
            'type' => 'tiny_mce',
            'option_category' => 'basic_option',
            'toggle_slug' => 'flipbox_content',
            'sub_toggle' => 'front_side'
        ...
        $module_fields['use_front_button'] = [
            'label' => esc_html__('Enable Front Side Button', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'default' => 'off',
            'options' => [
        ...
        $module_fields['back_title'] = [
            'label' => esc_html__('Back Side Title', 'dmpro-divi-modules-pro'),
            'type' => 'text',
            'toggle_slug' => 'flipbox_content',
        ...
        $module_fields['use_back_icon'] = [
            'label' => esc_html__('Enable Back Side Icon', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $module_fields["back_image_width"] = [
            'label' => esc_html__('Back Image Container Width', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'mobile_options' => true,
            'default' => '100%',
        ...
        $module_fields['back_icon'] = [
            'label' => esc_html__('Back Icon', 'dmpro-divi-modules-pro'),
            'type' => 'select_icon',
            'option_category' => 'basic_option',
            'default' => '5',
        ...
        $module_fields['back_content'] = [
            'label' => esc_html__('Back Side Content', 'dmpro-divi-modules-pro'),
            'type' => 'tiny_mce',
            'option_category' => 'basic_option',
            'toggle_slug' => 'flipbox_content',
            'sub_toggle' => 'back_side'
        ...
        $module_fields['use_back_button'] = [
            'label' => esc_html__('Enable Back Side Button', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'default' => 'off',
            'options' => [
        ...
        $module_fields['use_dynamic_height'] = [
            'label' => esc_html__('Equalize Flipbox Height', 'dmpro-divi-modules-pro'),
            'description' => esc_html__('Equalizing flipbox heights will force both sides of the flipbox to assume the height of the tallest side. Both sides of the flipbox will have the same height, keeping their appearance uniform.', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'default' => 'off',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $module_fields['use_force_square'] = [
            'label' => esc_html__('Enable Square Flipbox', 'dmpro-divi-modules-pro'),
            'description' => esc_html__('Enalbe this option to make the flipbox a perfect square. The height of will automatically equal the width of the flipbox.', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'default' => 'off',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $module_fields["flip_box_height"] = [
            'label' => esc_html__('Flipbox Height', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'mobile_options' => true,
            'default' => '250px',
        ...
        $module_fields["flip_box_speed"] = [
            'label' => esc_html__('Flip Speed', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '600ms',
            'default_unit' => 'ms',
        ...
        $module_fields["flip_box_align_front"] = [
            'label' => esc_html__('Front Horizontal Align', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'center',
            'options' => array(
        ...
        $module_fields["flip_box_align_front_vertical"] = [
            'label' => esc_html__('Front Vertical Align', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'center',
            'options' => array(
                'flex-start' => esc_html__('Top', 'dmpro-divi-modules-pro'),
                'center' => esc_html__('Center', 'dmpro-divi-modules-pro'),
                'flex-end' => esc_html__('Bottom', 'dmpro-divi-modules-pro'),
            ),
            'toggle_slug' => 'flipbox_settings',
        ];

        $module_fields["flip_box_align_back"] = [
            'label' => esc_html__('Back Horizontal Align', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'center',
            'options' => array(
        ...
        $module_fields["flip_box_align_back_vertical"] = [
            'label' => esc_html__('Back Vertical Align', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'basic_option',
            'default' => 'center',
            'options' => array(
        ...
        $module_fields["flip_box_animation"] = [
            'label' => esc_html__('Select Flipbox Animation', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'layout',
            'default' => 'flip_horizontally_ltr',
            'default_on_child' => true,
            'options' => [
                'flip_horizontally_ltr' => esc_html__('Left to Right', 'dmpro-divi-modules-pro'),
                'flip_horizontally_rtl' => esc_html__('Right to Left', 'dmpro-divi-modules-pro'),
                'flip_vertically_ttb' => esc_html__('Top to Bottom', 'dmpro-divi-modules-pro'),
                'flip_vertically_btt' => esc_html__('Bottom to Top', 'dmpro-divi-modules-pro'),
            ],
            'depends_show_if' => 'on',
            'toggle_slug' => 'flipbox_settings',
        ];
        ...
        $module_fields['use_3d_effect'] = [
            'label' => esc_html__('Enable 3D Content Effect', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $module_fields['use_3d_flip_box'] = [
            'label' => esc_html__('Enable 3D Flipbox', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'basic_option',
            'options' => [
                'off' => esc_html__('No', 'dmpro-divi-modules-pro'),
        ...
        $module_fields["flip_box_3d_flank_color"] = [
            'label' => esc_html__('Flip Box 3D Flank Color', 'dmpro-divi-modules-pro'),
            'type' => 'color-alpha',
            'custom_color' => true,
            'show_if' => [
                'use_3d_flip_box' => 'on',
        ...
        $more_settings['front_side_bg_color'] = [
            'label' => esc_html__('Front Background', 'dmpro-divi-modules-pro'),
        ...
        $more_settings['back_side_bg_color'] = [
            'label' => esc_html__('Back Background', 'dmpro-divi-modules-pro'),
            'type' => 'background-field',
    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields["box_shadow"]["default"] = [
            'label' => esc_html__('Flipbox Shadow', 'dmpro-divi-modules-pro'),
            'css' => [
        ...
        $advanced_fields['button']["front_button"] = [
            'label' => esc_html__('Front Button', 'dmpro-divi-modules-pro'),
            'css' => [
        ...
        $advanced_fields['button']["back_button"] = [
            'label' => esc_html__('Back Button', 'dmpro-divi-modules-pro'),
            'css' => [
        ...
        $advanced_fields['box_shadow']['back_icon_image'] = [
            'label' => esc_html__('Back Image Box Shadow', 'dmpro-divi-modules-pro'),
            'option_category' => 'layout',
            'tab_slug' => 'advanced',
            'show_if' => ['use_back_icon' => 'off'],
            'css' => [
    ...
    public function get_custom_css_fields_config() {
        ...
        $custom_css_fields['front_card_container'] = [
            'label' => esc_html__('Front Card Container', 'dmpro-divi-modules-pro'),
            'selector' => '%%order_class%% .dmpro-flip-box-front-side',
        ];

        $custom_css_fields['front_image_icon'] = [
            'label' => esc_html__('Front Image/Icon', 'dmpro-divi-modules-pro'),
        ...
        $custom_css_fields['front_description'] = [
            'label' => esc_html__('Front Description', 'dmpro-divi-modules-pro'),
        ...
        $custom_css_fields['back_card_container'] = [
            'label' => esc_html__('Back Card Container', 'dmpro-divi-modules-pro'),
            'selector' => '%%order_class%% .dmpro-flip-box-back-side',
        ];

        $custom_css_fields['back_image_icon'] = [
            'label' => esc_html__('Back Image/Icon', 'dmpro-divi-modules-pro'),
        ...
        $custom_css_fields['back_description'] = [
            'label' => esc_html__('Back Description', 'dmpro-divi-modules-pro'),
    ...
    public function render($attrs, $content = null, $render_slug) {
        $this->process_background(".dmpro-flip-box-front-side .dmpro-flip-box-front-side-wrapper", "front_side_bg", $render_slug);
        $this->process_background(".dmpro-flip-box-back-side .dmpro-flip-box-back-side-wrapper", "back_side_bg", $render_slug);
    ...
    public function _render_front_side() {
        ...
        if ('' !== $this->props['front_content']) {
            $front_content = sprintf(
                ...
                preg_replace('/^<\/p>(.*)<p>/s', '$1', $this->props['front_content'])
            );
        }
    ...
    public function _render_back_side() {
        ...
        if ('' !== $this->props['back_content']) {
            $back_content = sprintf(
                '<div class="dmpro-desc">%1$s</div>',
                preg_replace('/^<\/p>(.*)<p>/s', '$1', $this->props['back_content'])
            ); 
        }
