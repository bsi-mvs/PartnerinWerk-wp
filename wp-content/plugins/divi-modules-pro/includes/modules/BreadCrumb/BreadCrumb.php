...
class DMPRO_BreadCrumb extends ET_Builder_Module { 
    ...
    public function init() {
        ...
        $this->vb_support = 'on';
        $this->name = esc_html__(DMPRO_PREFIX . 'Breadcrumbs', 'dmpro-divi-modules-pro');
        $this->main_css_element = '%%order_class%%.dmpro_breadcrumbs';
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'settings' => esc_html__('Breadcrumb Settings', 'dmpro-divi-modules-pro'),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    ...
                    'breadcrumb_style' => [
                        ...
                        'title' => esc_html__('Breadcrum Style', 'dmpro-divi-modules-pro'),
                        'priority' => 2,
                    ],
                    'separator'         => esc_html__('Breacrumb Separator Style', 'dmpro-divi-modules-pro'),
                ],
            ],
        ];
    }
    public function get_fields() {
        ...
        $module_fields["bc_custom_home"] = [
            'label' => esc_html__('Customize Homepage Breadcrumb', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
        ...
        $module_fields["bc_home_text"] = [
            'label' => esc_html__('Homepage Text', 'dmpro-divi-modules-pro'),
            'type' => 'text',
        ...
        $module_fields["bc_home_url"] = [
            'label' => esc_html__('Homepage Url', 'dmpro-divi-modules-pro'),
            'type' => 'text',
            'option_category' => 'basic_option',
            'depends_show_if' => 'on',
            'depends_on' => [
        ...
        $module_fields["bc_home_icon"] = [
            'label' => esc_html__('Enable Home Icon', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'configuration',
            'options' => array(
                'on'  => esc_html__('Yes', 'dmpro-divi-modules-pro'),
        ...
        $module_fields['bc_separator'] = [
            'label' => esc_html__('Breadcrumb Separator', 'dmpro-divi-modules-pro'),
            'type' => 'select',
            'option_category' => 'configuration',
            'options' => [
                'icon' => esc_html__('Icon', 'dmpro-divi-modules-pro'),
                'symbol' => esc_html__('Custom Text Symbol', 'dmpro-divi-modules-pro'),
            ],
            'default' => 'icon',
            'toggle_slug' => 'settings'
        ];
        $module_fields["bc_home_size"] = [
            'label' => esc_html__('Home Icon Size', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '16px',
            'default_unit' => 'px',
        ...
        $module_fields["bc_home_color"] = [
            'label'             => esc_html__('Home Icon Color', 'dmpro-divi-modules-pro'),
            'type'              => 'color-alpha',
            'depends_show_if'   => 'on',
            'tab_slug'          => 'advanced',
            'toggle_slug'       => 'settings'
        ...
        $module_fields["bc_hover_home_color"] = [
            'label'             => esc_html__('Home Hover Icon Color', 'dmpro-divi-modules-pro'),
            'type'              => 'color-alpha',
            'depends_show_if' => 'on',
            'depends_on' => [
                'bc_custom_home'
        ...
        $module_fields["bc_separator_icon"] = [
            'label'              => esc_html__('Separator Icon', 'dmpro-divi-modules-pro'),
            'type'               => 'select_icon',
            'default'            => '$',
            'toggle_slug'        => 'settings',
            'tab_slug' => 'advanced',
        ...
        $module_fields["bc_separator_sysmbol"] = [
            'label' => esc_html__('Separator Symbol', 'dmpro-divi-modules-pro'),
            'type' => 'text',
            'option_category' => 'basic_option',
        ...
        $module_fields["bc_schema"] = [
            'label' => esc_html__('Enable Schema Markup', 'dmpro-divi-modules-pro'),
            'type' => 'yes_no_button',
            'option_category' => 'configuration',
            'options' => array(
                'on'  => esc_html__('Yes', 'dmpro-divi-modules-pro'),
        ...
        $module_fields["bc_separator_size"] = [
            'label' => esc_html__('Separator Size', 'dmpro-divi-modules-pro'),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '16px',
            'default_unit' => 'px',
        ...
        $module_fields['bc_active_item_padding'] = [
            'label' => esc_html__('Active Item Padding', 'dmpro-divi-modules-pro'),
            'type' => 'custom_margin',
            'option_category' => 'basic_option',
            'mobile_options' => true,
            'responsive' => true,
    ...
    ?>
        <?php if ( is_home() || is_front_page() ) : ?>
            <li <?php echo $schema_item_list_element; ?> class="dmpro-breadcrumb-item dmpro-breadcrumb-home">
        ...
        <?php else : 
         ...
         ?>
            ...
            <?php if(is_page() && !$parent_id ) : ?>
                <li <?php echo $schema_item_list_element; ?> class="dmpro-breadcrumb-item dmpro-breadcrumb-current">
                    <span <?php echo $schema_item_name; ?>>
            ...
            ?>
                <li <?php echo $schema_item_list_element; ?> class="dmpro-breadcrumb-item">
